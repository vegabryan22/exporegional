...
## Mantenimiento del proyecto y validación documental

Cada colegio mantiene desde su propio panel los recursos, necesidades operativas, PDF, logo y fotografías de sus proyectos. Para los registros manuales no puede enviar el proyecto mientras falten el documento, el logo o alguna fotografía. La coordinación regional no completa estos elementos: revisa el PDF y resuelve el expediente documental. Si el colegio reemplaza o retira el documento, su validación regional se reinicia; los cambios de recursos visuales no alteran el estado de evaluación.
